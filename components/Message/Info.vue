...
<template>
  <div>
    <div
      ...
      class="mx-auto mb-5 mt-5 p-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:bg-gray-800 dark:text-gray-400"
      role="alert"
    >
      <div class="flex">
        <div
        ...
        <div class="ml-3 text-sm font-normal">
          <span class="mb-1 text-sm font-semibold text-gray-900 dark:text-white"
            >Dark Mode available</span
          >
          <div class="mb-2 text-sm font-normal">
            Feel feel to try it out and switch the themes!
          </div>
